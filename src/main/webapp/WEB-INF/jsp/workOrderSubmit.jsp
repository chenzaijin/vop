...
<div>
    <table>
        <tbody>
        <tr>
            <td><label><span class="redfont">*</span>工单编号</label><input id="support_id" type="text" align="right"> </td>
            <td><label><span class="redfont">*</span>工单类型</label><select id="support_type" align="right" onchange="selectWorkType()"><option value="01">网络使用类</option><option value="02">服务开通变更类</option>
        ...
        <tr>
            <td><label><span class="redfont">*</span>用户手机号码</label><input id="phone_number" type="text"></td>
            <td><label><span class="redfont">*</span>用户联系人姓名</label><input id="contact" type="text"></td>
            <td><label><span class="redfont">*</span>用户联系人电话</label><input id="contact_number" type="text"></td>
        </tr>
        <tr>
            <td><label><span class="redfont">*</span>转售企业联系人</label><input id="mvno_contact" type="text"></td>
            <td><label><span class="redfont">*</span>转售企业联系电话</label><input id="mvno_contact_number" type="text"></td>
            <td></td>
        </tr>
        <tr>
            <td><label><span class="redfont">*</span>工单级别</label><select id="support_level"><option value="common">一般</option><option value="emergency">紧急</option></select></td>
            <td><label><span class="redfont">*</span>问题发生省分编码</label><select id="issue_province"></select></td>
            <td><label><span class="redfont">*</span>问题发生地市编码</label><select id="issue_city"></select></td>
        </tr>
        <tr>
            <td><label><span class="redfont">*</span>用户号码归属省编码</label><select id="phone_number_province"></select></td>
            <td><label><span class="redfont">*</span>用户号码归属地市编码</label><select id="phone_number_city"></select></td>
        ...
        <tr>
            ...
            <td colspan="2"><label>重复派单说明</label><textarea id="repetition_description" class="comments"></textarea></td>
        </tr>
        <tr>
            <td colspan="3"><label ><span class="redfont">*</span>核查处理情况</label><textarea id="present_condition" class="comments"></textarea></td>
        </tr>
        <tr>
        ...
        <tbody id="network" class="entityTbody">
            ...
            <tr>
                <td><label><span class="redfont">*</span>业务类别</label><select id="network_type"><option value="1">语音业务</option><option value="2">数据业务</option>
            ...
            <tr>
                ...
                <td colspan="2"><label><span class="redfont">*</span>投诉问题描述</label><textarea id="issue_description" class="comments"></textarea></td>
            </tr>
        ...
        <tbody id="billing" style="display:none;" class="entityTbody">
            ...
            <tr>
                <td><label><span class="redfont">*</span>话单类型</label><select id="cdr_type"><option value="1">语音话单</option><option value="2">数据话单</option>
        ...
        <tbody id="vas" style="display:none;" class="entityTbody">
            ...
            <tr>
                ...
                <td><label><span class="redfont">*</span>增值业务类型</label><select id="vas_type"><option value="1">炫铃</option><option value="0">其他</option></select></td>
                <td></td>
            </tr>
            <tr>
                <td colspan="3"><label>业务描述</label><textarea id="vas_description" class="comments"></textarea></td>
            </tr>
            <tr>
        ...
        <tbody id="recharge" style="display:none;" class="entityTbody">
            ...
            <tr>
                <td><label><span class="redfont">*</span>是否到帐</label><select id="paying_arrive"><option value="false">未到帐</option><option value="true">到帐</option></select></td>
        ...
        <tbody id="account" style="display:none;" class="entityTbody">
            ...
            <tr>
                <td><label><span class="redfont">*</span>API 名称</label><input id="api_name" type="text"></td>
                <td><label><span class="redfont">*</span>流水号</label><input id="swift_number" type="text"></td>
                <td><label><span class="redfont">*</span>定单 ID</label><input id="order_id" type="text"></td>
            </tr>
            <tr>
